...
%%%%%%%%%%%%%%%%%%% VM Migration: test by the tenant %%%%%%%%%%%%%%%%%%%%%%%%
moments = 5 : 5 : 95;
moments = [moments, 98];
...
fig_path = strcat('../New_Data_box_moments_fit/', mat2str(ticket_thres),'_Target_MigrationOnly_Fig/');
mkdir(fig_path);
...
%                       'p_{test1:test2} =', {' '}, mat2str(round(p3, 4)));
        ...
        if test_id == 2
            ...
            hold on
            plot([ticket_thres ticket_thres], get(gca,'ylim'), 'm-', 'linewidth', 1.5)
