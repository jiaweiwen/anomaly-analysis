...
path1 = '../New_Data_time_series_linear_subset_vif_figure/';
...
mkdir('../New_Data_VM_Ticket_Reduction_Performance_Figure');
path = '../New_Data_VM_Ticket_Reduction_Performance_Figure/';
